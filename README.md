...
1. clone this repo: `git clone git@github.com:Alex-0407/cordova-plugin-app.git`
...
#### 欢迎关注我的微信公众号 <font color=red face="黑体">`全栈弄潮儿`</font> ，获取更多`angular`、`ionic`、`cordova`、`react`、`vue`、`nodejs`、`android`、`ios`等学习资源
